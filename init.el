...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-trello habitica js-doc cnfonts counsel auto-complete page-break-lines yasnippet-snippets yasnippet-snippetst yasnippet doom-themes use-package lsp-python company-lsp lsp-javascript-typescript lsp-ui lsp-mode eyebrowse which-key typescript-mode magit ivy web-mode))))
(custom-set-faces
